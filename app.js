  ...
  try {
    ...
    for (let i = 0; i < scorebatData.length; i++) {
      for (let j = 0; j < scorebatData[i].videos.length; j++) {
        ...
        let buscarChampions = scorebatData[i].competition.name.indexOf("CHAMPIONS LEAGUE:")
    ...
    //TODO Liga Argentina de Futbol cuando publiquen en el JSON alguno para ver como filtrarlos
      }
    }
